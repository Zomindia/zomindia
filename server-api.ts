...
router.post("/bookings/create", async (req: any, res: any) => {
  try {
    ...
    const bookingPayload = {
      ...
      address,
      lat: (req.body.lat !== undefined && req.body.lat !== null && !isNaN(Number(req.body.lat))) ? Number(req.body.lat) : null,
      lng: (req.body.lng !== undefined && req.body.lng !== null && !isNaN(Number(req.body.lng))) ? Number(req.body.lng) : null,
