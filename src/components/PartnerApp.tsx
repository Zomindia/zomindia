...
export default function PartnerApp({ profile, initialTab = 'home', targetBookingId: initialTargetId, onNavigate: onAppNavigate }: Props) {
  ...
  const renderPartnerSkeleton = () => {
    return (
      <div className="space-y-6 p-4 animate-pulse select-none">
        {/* Earnings Stats mimic */}
        ...
        <div className="flex justify-between items-center px-1">
          <div className="w-28 h-5 bg-slate-100 rounded-lg" />
          <div className="w-16 h-4 bg-slate-100 rounded" />
        </div>

        {/* Job Cards list mimic */}
              ...
              <div className="flex justify-between items-start">
                <div className="flex gap-3">
                  ...
                  <div className="space-y-2">
                    <div className="w-32 h-4.5 bg-slate-100 rounded" />
    ...
    <div className="min-h-[100dvh] bg-slate-50 pb-32 flex flex-col max-w-md mx-auto relative shadow-2xl overflow-hidden border-x border-slate-200">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar scroll-smooth">
        <AnimatePresence mode="wait">
          ...
          >
            {loading ? renderPartnerSkeleton() : renderScreen()}
          </motion.div>
        </AnimatePresence>
      </main>
