...
export default function AboutUs({ onNavigate }: AboutUsProps) {
  return (
    <motion.div 
      ...
      className="bg-slate-50 min-h-screen text-slate-900 !bg-slate-50 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-12 sm:space-y-16"
    >
      ...
      {/* Hero Banner Section */}
      <div className="bg-gradient-to-br from-blue-50/90 via-slate-50 to-indigo-50/70 rounded-[36px] p-8 sm:p-12 border border-blue-100 shadow-sm relative overflow-hidden">
        <div className="absolute right-0 top-0 bottom-0 w-1/2 bg-[radial-gradient(circle_at_top_right,rgba(5,12,166,0.06),transparent_70%)] pointer-events-none" />
        
        <div className="relative z-10 max-w-3xl space-y-5">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100/80 border border-blue-200/90 text-xs font-black uppercase tracking-widest text-[#050CA6]">
            <Sparkles size={14} className="text-[#050CA6]" /> Indore's #1 On-Demand Home Service Platform
          </div>

          <h1 className="text-3xl sm:text-5xl font-black tracking-tight italic text-blue-950 leading-tight">
            Welcome to Zomindia
          </h1>

          <p className="text-base sm:text-lg text-slate-700 font-medium leading-relaxed">
            Officially registered as <strong className="text-blue-950 font-bold">{COMPANY_NAME}</strong>, we are based right here in Indore, MP, INDIA. Our mission is simple: to make home life seamless, stress-free, and delightful by connecting you with verified, elite service professionals.
          </p>

          <div className="flex flex-wrap items-center gap-4 pt-2">
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-2xl border border-slate-200/90 text-xs font-bold text-slate-800 shadow-2xs">
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Leader 1: Ranu */}
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-100 shadow-sm flex flex-col gap-6 items-start hover:border-blue-200 transition-all">
            <div className="space-y-3 flex-1">
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="text-xl font-bold text-slate-900">Ranu</h3>
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-amber-50 text-amber-700 border border-amber-200/60">Age: 27</span>
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-blue-50 text-[#050CA6] border border-blue-200/60">Indore HQ</span>
                </div>
            ...
            <div className="space-y-3 flex-1">
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-amber-50 text-amber-700 border border-amber-200/60">Age: 35</span>
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-blue-50 text-[#050CA6] border border-blue-200/60">Indore HQ</span>
                </div>
      ...
      <div className="bg-slate-50 border border-slate-200/80 p-8 sm:p-12 rounded-[36px] shadow-sm space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-2">
            <h3 className="text-2xl font-black italic text-slate-900">Need Assistance or Ready to Book?</h3>
          ...
          <div className="flex items-center gap-3 shrink-0 flex-wrap">
            <button
              onClick={() => onNavigate('home')}
              className="px-6 py-3.5 rounded-2xl bg-[#050CA6] hover:bg-blue-700 text-white font-black text-xs uppercase tracking-wider shadow-sm transition-all"
            >
              Explore Services
            </button>
            <button
              onClick={() => onNavigate('contact')}
              className="px-6 py-3.5 rounded-2xl bg-white hover:bg-slate-100 text-slate-800 font-black text-xs uppercase tracking-wider border border-slate-300 transition-all shadow-xs"
            >
              Contact Support
            </button>
          </div>
        ...
        <div className="border-t border-slate-200/90 pt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
          <button
            onClick={() => onNavigate('help')}
            className="flex items-center gap-2 p-3.5 rounded-xl bg-white hover:bg-blue-50/70 text-slate-700 hover:text-[#050CA6] border border-slate-200/80 transition-all text-left font-bold shadow-2xs"
          >
            <HelpCircle size={16} className="text-[#050CA6] shrink-0" />
          ...
          <button
            ...
            className="flex items-center gap-2 p-3.5 rounded-xl bg-white hover:bg-blue-50/70 text-slate-700 hover:text-[#050CA6] border border-slate-200/80 transition-all text-left font-bold shadow-2xs"
          >
            <RotateCcw size={16} className="text-rose-600 shrink-0" />
